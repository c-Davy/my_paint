var my_paint = function(){
	...
	//Supprime le canvas lorque le trait bouge a l'aide de la souris.
	...
	this.save = function(){
		this.canvas.toBlob(function(blob){
			saveAs(blob, prompt('enter name file') + '.png');
		});
	}
...
// Limite de dessin, espace en haut et a gauche du canvas + appel de ma fonction si le click de la souris est actif.
